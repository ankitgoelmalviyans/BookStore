...
/// <summary>Cosmos-backed Inbox store, sharing the same ProcessedMessages container InventoryService already uses (the dedup key is the event's identity, not any one product's).</summary>

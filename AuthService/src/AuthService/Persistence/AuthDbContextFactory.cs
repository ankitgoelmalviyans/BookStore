...
/// <c>AUTH_DB_CONNECTION</c> environment variable, falling back to a local SQL LocalDB using
...
public class AuthDbContextFactory : IDesignTimeDbContextFactory<AuthDbContext>
{
    public AuthDbContext CreateDbContext(string[] args)
    {
        var connectionString =
            ...
            ?? "Server=(localdb)\\mssqllocaldb;Database=BookStoreAuth;Trusted_Connection=True;TrustServerCertificate=True";
